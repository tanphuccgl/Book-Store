...
import 'package:book_store/feature/product_loai6/presentation/widget/body_product6_details.dart';
import 'package:flutter/cupertino.dart';
import 'package:flutter/material.dart';
import 'package:flutter_bloc/flutter_bloc.dart';

class Product6DetailPage extends StatefulWidget {
  static const String routeName = '/Product6DetailPage';



  const Product6DetailPage({Key key}) : super(key: key);

  @override
  _Product6DetailPageState createState() => _Product6DetailPageState();
}

class _Product6DetailPageState extends State<Product6DetailPage> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body: Padding(
          ...
          child: Column(
            children: [
              header(context: context,title:"Tủ sách chữa lành",onPressed2: (){ Navigator.pushReplacementNamed(context, PageRoutes.cartPage);} ),
  ...
  BlocProvider<Product6Bloc> _buildBody(BuildContext context) {
    return BlocProvider(
        create: (_) => sl<Product6Bloc>(),
        child: Expanded(
