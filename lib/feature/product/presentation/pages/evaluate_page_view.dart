...
Widget pageEvaluate({BuildContext context,List<ProductData> list,Key key,ScrollController controller}) {
  ...
  return Container(
      ...
      child: ListView.builder(
        ...
        itemBuilder: (context, index) {
          final List<ProductData> list1 = list.toList();
          list1.shuffle();
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  _priceProduct(pricee: list2[index].giaBia,context: context),
                ],
              ),
            ),
          );
